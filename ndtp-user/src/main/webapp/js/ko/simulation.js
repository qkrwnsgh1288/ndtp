...
var Simulation = function(magoInstance, viewer, $) {
	...
	_camera_scene.push({
		position: new Cesium.Cartesian3(1332835.008482219, -4655204.019513882, 4138273.7480046735),
		direction: new Cesium.Cartesian3(0.6993917934454742, 0.7031820594327531, -0.12800824408230602),
		up: new Cesium.Cartesian3(0.5875541046851481, -0.4636622862761701, 0.663172268986565),
		right: new Cesium.Cartesian3(0.4069782467512645, -0.5390290118139154, -0.7374391033123894)
	});
	_camera_scene.push({
		position: new Cesium.Cartesian3(1331324.007532877, -4656702.881425851, 4136247.8365154187),
		direction: new Cesium.Cartesian3(0.4219053192126218, 0.756271814549074, 0.5000488417532301),
		up: new Cesium.Cartesian3(0.2707634732007081, -0.6314733502254427, 0.726586918087124),
		right: new Cesium.Cartesian3(0.8652647243476328, -0.1711559244481673, -0.4711927485922381)
	});
	_camera_scene.push({
		position: new Cesium.Cartesian3(1345307.099096169, -4638646.776090109, 4152272.4070921885),
		direction: new Cesium.Cartesian3(-0.2787111497010455, 0.06125310214495733, -0.9584196119184649),
		up: new Cesium.Cartesian3(0.012016577136128553, -0.9976634099652599, -0.06725564876217699),
		right: new Cesium.Cartesian3(-0.9602997953276118, -0.03026182238579267, 0.27732386337933107)
	});
